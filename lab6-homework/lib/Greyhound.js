...
function (_Dog) {
  ...
  function Greyhound(name) {
    ...
    _this = _possibleConstructorReturn(this, (Greyhound.__proto__ || Object.getPrototypeOf(Greyhound)).call(this, name, _Breed.Breed.Greyhound, weight, height));
